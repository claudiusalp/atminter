...
from lib.modules import paperparse as pp
...
parser.add_argument("-o", "--output", help="output directory",
                    default=os.path.join(minter_root, "output", "svm_scanner"))
parser.add_argument("-j", "--json", help="Use json files instead", action="store_true",
                    default=1)  # change to sp switch
