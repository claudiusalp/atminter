...
import src.main.python.SVM.svm_core as sc
import argparse
import os
import numpy as np
import pickle
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", help="Output path for pickled SVM",
                        default=os.path.join(minter_root, "output", "trained_svms", "trained_svm.pickle"))
